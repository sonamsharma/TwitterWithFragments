...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_URL = "https://api.twitter.com/1.1"; // Change
																			...
																			// API
																			// URL
	public static final String REST_CONSUMER_KEY = "AGnIXDihc9Hq5lryK3lU3vaj6"; // Change
																				// this
	public static final String REST_CONSUMER_SECRET = "PCZAly4w7HMbx0Qi2OT4IvVE1iGRkYmyWuoppVy9eIg57yoFZk"; // Change
																											// this
	...
	public void getUserTimeline(AsyncHttpResponseHandler handler,
			long since_id, long max_id, long user_id) {
		// TODO Auto-generated method stub
		RequestParams params = new RequestParams();
		if (max_id >= 0) {
			params.put("max_id", String.valueOf(max_id));
	...
	/*
	 * public void getUser(AsyncHttpResponseHandler handler) { String apiUrl =
	 * getApiUrl("account/verify_credentials.json"); client.get(apiUrl,
	 * handler); }
	 */
	// CHANGE THIS
